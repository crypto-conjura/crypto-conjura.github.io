% =====================================================================
%  SOLUTION DOCUMENT.  Resolves Conjecture 2 (public seed) of the
%  companion statement (main.tex in this folder); Conjecture 1
%  (secret seed) is not addressed and remains open.  Along the way,
%  the naive transposition of Conjecture 1 to the public-seed game is
%  shown false (Proposition~\ref{prop:false}), which is what motivates
%  the corrected bound.
%
...
Conjectures} (see \texttt{main.tex} in this folder) --- proven true.
...
also disproven here (Proposition~\ref{prop:false}).}
