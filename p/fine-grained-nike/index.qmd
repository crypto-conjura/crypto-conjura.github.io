...
Both statements were drafted by `scripts/harvest_conjectures.py` from that PDF and are AI-written and unreviewed, as the [status badges](/open-problems/status-legend/) say. Each is posed by the paper itself, in its own voice, as a route to closing the gap its results leave.
