...
trapdoor-free Fiat--Shamir route of Lyubashevsky~\cite{Lyu09,Lyu12} is
proved by rewinding and is not amenable to a tight reduction to SIS;
tight proofs for Fiat--Shamir lattice signatures, including
Dilithium's~\cite{KLS18}, instead go through lossy identification and
...
\emph{A concrete treatment of Fiat--Shamir signatures in the quantum
random-oracle model}.
EUROCRYPT 2018, Part III, LNCS 10822, pages 552--586, Springer, 2018.
...
\bibitem[Lyu09]{Lyu09}
V. Lyubashevsky.
\emph{Fiat--Shamir with aborts: Applications to lattice and
factoring-based signatures}.
ASIACRYPT 2009, LNCS 5912, pages 598--616, Springer, 2009.
