...
\toprule
 & secret & min-ent. & key & \multicolumn{2}{c}{salt needed (bits)} \\
\cmidrule(l){5-6}
 & $D$ & bits & bits & conjectured & route \\
\midrule
DH element in a 2048-bit group, $\delta = 2^{-32}$ & $2^{2048}$ & $256$ & $128$ & $77$  & $190$ \\
the same, at a 256-bit key, $\delta = 2^{-64}$      & $2^{2048}$ & $512$ & $256$ & $141$ & $382$ \\
a 512-bit source, $\delta = 2^{-64}$                & $2^{512}$  & $300$ & $128$ & $139$ & $254$ \\
\bottomrule
\end{tabular}
\end{center}
