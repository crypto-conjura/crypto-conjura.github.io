...
An AI — potentially multi-agent, potentially distributed across machines — is tasked with working the topic: surveying the relevant literature, generating candidate statements, checking its own results, and autoformalizing whatever holds up. A proposal is the seed of a [paper](/projects/index.qmd), or of an [open problem](/problems/index.qmd) if what comes out is a precise, unresolved statement rather than a resolved write-up.
