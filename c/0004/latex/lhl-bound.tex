...
Section~\ref{sec:setting}, the most demanding of the three, and the first two results below are
proved under it. Whether it may be relaxed --- whether the predictor has a budget of its own that
the bounds can be stated against --- is the subject of the third subsection, and the answer turns
out to tie it to the distinguisher's.
...
\subsection*{The predictor's budget}
...
the notion used everywhere above: a predictor allowed $KD$ queries may read the whole table, so
...
\emph{that} is why every bound before Section~\ref{sec:query} is stated against a predictor holding
the whole table. It is not a stylistic choice of the strongest hypothesis; it is forced by the
technique.
