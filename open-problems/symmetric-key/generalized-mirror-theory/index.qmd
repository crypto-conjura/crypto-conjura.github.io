...
**Resolution:** <span class='cj-badge cj-badge-open'>○ Open</span> &nbsp; **Verification:** <span class='cj-badge cj-badge-ai'>AI-reviewed</span> &nbsp; **Artifact Check:** <span class='cj-badge cj-badge-ai'>AI-checked</span>
...
Only the conjecture's *statement* has been formalized so far (as a Lean theorem ending in `sorry` — see `lean/Statement.lean`), not a proof. Once a proof exists, name who/what formalized and checked it the same way, and update the `proof:` badge above.
