...
Placeholder. There is one [paper](/projects/uber-groups-rsr/index.qmd) on the site so far and no committee yet. Fill in the list below once a committee actually forms.
:::
...
Once a member reviews a paper, their name is added to that paper's `Reviewers` field (see the [paper template](https://github.com/crypto-conjura/crypto-conjura.github.io/blob/main/_templates/paper.qmd)), which accumulates across reviews rather than being overwritten.
