...
Both conjectures were stated together as a single self-contained write-up (statement by Pooya Farshim), duplicated byte-for-byte into both folders. On 28 August 2026 that note was split in two, so each statement page now links a PDF stating exactly the one conjecture the page states, each cross-referencing the other; the numbering of the shared note, in which the secret-seed conjecture was Conjecture 1 and the public-seed one Conjecture 2, survives only inside the solution note, which reproduces both. The public-seed case was resolved shortly after: an AI-written proof (Claude Opus 5, prompted by Pooya Farshim, 14 August 2026) shows the naive guess -- transposing the secret-seed expression directly to the public-seed game -- is false, and proves a corrected bound instead, with an explicit near-optimal constant. That proof has not yet been independently reviewed by a human, nor formalized. The secret-seed case was tracked as [c/0005](/c/0005/), transcribed from the same PDF; no proof of it is recorded, and it was withdrawn on 17 August 2026, so it no longer appears in the listings. A bound for it was referenced only informally, via an unincluded and unverified "companion note," in the public-seed resolution's write-up, and that note is still not on the site.
...
Both tracked cells are real: the single-source public-seed cell is cited research, and the single-source secret-seed cell ([c/0005](/c/0005/)) is the other half of the same shared write-up. Neither $k$-source cell is stated. Nobody has posed either one, here or elsewhere that this archive knows of, and an empty cell is a research prompt rather than an omission.
