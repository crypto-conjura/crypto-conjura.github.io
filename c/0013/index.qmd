...
topics: [blind-signatures, signature-schemes, generic-group-model, black-box-separations]
model: ggm
form: impossibility
...
revision: 1
statement_sha: "d7795fe272a2df06095e92da11b931c85c00b457883fba8c3b3542dc58a5eb0b"
...
**Checked against the literature, 2026-08-19.** Searched citations of Dietz–Kastner–Tessaro (eprint 2026/090) and Kastner–Tessaro–Zaverucha (eprint 2026/091), plus CRYPTO 2026 program chatter, for any paper extending the impossibility beyond the $O(\log \lambda)$ query budget or refuting it with a construction; found neither — the companion 2026/091 scheme is round-optimal only via a non-black-box technique (NIZKs over a group-to-scalar conversion) outside this conjecture's GGM-generic scope, which the page's own sources already account for. Still open.
