...
The statement was drafted by `scripts/harvest_conjectures.py` from that PDF and is AI-written and unreviewed, as its [status badge](/problems/status-legend/) says.
