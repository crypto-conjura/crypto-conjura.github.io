...
[**Generalizing beyond the iris, and beyond the lab**]{#generalizing-beyond-the-iris-and-beyond-the-lab}
...
[**$\zeta$-sampling for PUF-based fuzzy extractors**]{#zeta-sampling-for-puf-based-fuzzy-extractors}
...
[**Competitive collateral policies under condition-dependent settlement**]{#competitive-collateral-policies-under-condition-dependent-settlement}
...
[**Adaptive, dynamic wallet and collateral policies**]{#adaptive-dynamic-wallet-and-collateral-policies}
...
[**Multi-stage crooked indifferentiability**]{#multi-stage-crooked-indifferentiability}
...
[**Broader applications and a practical construction**]{#broader-applications-and-a-practical-construction}
...
[**Tight consistency analysis for proof-of-stake GHOST**]{#tight-consistency-analysis-for-proof-of-stake-ghost}
...
[**Accountable peg-out**]{#accountable-peg-out}
...
[**Strengthening and transplanting the sum-of-squares entanglement-detection technique**]{#strengthening-and-transplanting-the-sum-of-squares-entanglement-detection-technique}
...
[**A general theory of computational hardness**]{#a-general-theory-of-computational-hardness}
...
[**Other matching heuristics for tree construction**]{#other-matching-heuristics-for-tree-construction}
...
[**Leakage from tree rearrangement**]{#leakage-from-tree-rearrangement}
...
[**Classifying hard distributions of low-degree polynomials**]{#classifying-hard-distributions-of-low-degree-polynomials}
...
[**A general non-black-box separation for PKE from OWFs**]{#a-general-non-black-box-separation-for-pke-from-owfs}
...
[**Escaping the perfect-uniqueness impossibility for VDFs**]{#escaping-the-perfect-uniqueness-impossibility-for-vdfs}
...
[**A meaningful collapse-binding property for non-interactive commitments**]{#a-meaningful-collapse-binding-property-for-non-interactive-commitments}
...
[**A general theory of monolithic black-box uselessness**]{#a-general-theory-of-monolithic-black-box-uselessness}
...
[**Simulator-based proofs for compressed permutation oracles**]{#simulator-based-proofs-for-compressed-permutation-oracles}
...
[**Adaptive corruptions for everlasting UC commitment from malicious PUFs**]{#adaptive-corruptions-for-everlasting-uc-commitment-from-malicious-pufs}
...
[**Reusing the quantum heavy-queries learner for other QROM separations**]{#reusing-the-quantum-heavy-queries-learner-for-other-qrom-separations}
...
[**Communication-complexity lower bounds for QROM key agreement**]{#communication-complexity-lower-bounds-for-qrom-key-agreement}
...
[**Relating the Polynomial Compatibility and Aaronson–Ambainis conjectures**]{#relating-the-polynomial-compatibility-and-aaronsonambainis-conjectures}
...
[**Leakage-freeness for possibly-divergent programs**]{#leakage-freeness-for-possibly-divergent-programs}
...
[**The theoretical limits of publicly-detectable watermarking**]{#the-theoretical-limits-of-publicly-detectable-watermarking}
...
[**New robustness notions for publicly-detectable watermarks**]{#new-robustness-notions-for-publicly-detectable-watermarks}
...
[**3-party NIKE from non-pairing algebraic assumptions**]{#party-nike-from-non-pairing-algebraic-assumptions}
...
[**Applying leakage-freeness definitions to Kyber**]{#applying-leakage-freeness-definitions-to-kyber}
...
[**Post-quantum security of permutation-based hashing**]{#post-quantum-security-of-permutation-based-hashing}
...
[**A workable decompression operator for permutations**]{#a-workable-decompression-operator-for-permutations}
...
[**Extending the top-down ansatz to correlated-output oracles**]{#extending-the-top-down-ansatz-to-correlated-output-oracles}
...
[**Extending QROM time-lock-puzzle impossibility to VDFs**]{#extending-qrom-time-lock-puzzle-impossibility-to-vdfs}
...
[**Post-quantum minimality for other primitives**]{#post-quantum-minimality-for-other-primitives}
...
[**Porting DAG-based BFT protocols to the permissionless, adaptive setting**]{#porting-dag-based-bft-protocols-to-the-permissionless-adaptive-setting}
...
[**A compact, on-chain-postable certificate of ML training work**]{#a-compact-on-chain-postable-certificate-of-ml-training-work}
...
[**Bypassing the round-optimality barrier with a non-group assumption**]{#bypassing-the-round-optimality-barrier-with-a-non-group-assumption}
...
[**Direct, specialized constructions for threshold signatures and encryption**]{#direct-specialized-constructions-for-threshold-signatures-and-encryption}
...
[**A seeded proof-of-work compatible with distributed samplers**]{#a-seeded-proof-of-work-compatible-with-distributed-samplers}
...
[**Sequential composition and dynamic difficulty adjustment**]{#sequential-composition-and-dynamic-difficulty-adjustment}
...
[**Removing the CRS and minimizing assumptions**]{#removing-the-crs-and-minimizing-assumptions}
...
[**Collusion that harms rather than profits**]{#collusion-that-harms-rather-than-profits}
...
[**A multi-tiered, richer strategy space**]{#a-multi-tiered-richer-strategy-space}
...
[**Identifiable abort for Tweed**]{#identifiable-abort-for-tweed}
...
[**A meaningful SPV-style bridge in the paper's formal model**]{#a-meaningful-spv-style-bridge-in-the-papers-formal-model}
...
[**Further security notions in the same formal framework**]{#further-security-notions-in-the-same-formal-framework}
...
[**A tight QROM proof from a search assumption**]{#a-tight-qrom-proof-from-a-search-assumption}
...
[**Extending tightness to the multi-user setting**]{#extending-tightness-to-the-multi-user-setting}
...
[**UC realizations with many bulletin-board managers**]{#uc-realizations-with-many-bulletin-board-managers}
...
[**Modeling monetary stakes and a game-theoretic incentive analysis**]{#modeling-monetary-stakes-and-a-game-theoretic-incentive-analysis}
...
Eliana Carozza, Geoffroy Couteau. [*On Threshold Signatures from MPC-in-the-Head*](https://eprint.iacr.org/2024/1897). IACR ePrint Archive 2024/1897.

[**Grand unification of MPC-in-the-Head and VOLE-in-the-Head**]{#grand-unification-of-mpc-in-the-head-and-vole-in-the-head}

<!-- topics:start -->
<div class="cj-tags cj-page-topics"><a class="cj-tag cj-tag-topic" href="/projects/proposals/by-topic/index.qmd#mpc-in-the-head">Mpc In The Head</a><a class="cj-tag cj-tag-topic" href="/projects/proposals/by-topic/index.qmd#threshold-signatures">Threshold Signatures</a></div>
<!-- topics:end -->
...
Antonina Bondarchuk, Olive Chakraborty, Geoffroy Couteau, Renaud Sirdey. [*Downlink (T)FHE Ciphertexts Compression*](https://eprint.iacr.org/2024/1921). IACR ePrint Archive 2024/1921.

[**Rescaling before truncation for BGV, BFV, and CKKS**]{#rescaling-before-truncation-for-bgv-bfv-and-ckks}

<!-- topics:start -->
<div class="cj-tags cj-page-topics"><a class="cj-tag cj-tag-topic" href="/projects/proposals/by-topic/index.qmd#homomorphic-encryption">Homomorphic Encryption</a></div>
<!-- topics:end -->
...
[**Compression for partially-filled RLWE ciphertexts**]{#compression-for-partially-filled-rlwe-ciphertexts}
...
Yevgeniy Dodis, Daniel Jost, Shuichi Katsumata, Thomas Prest, Rolfe Schmidt. [*Triple Ratchet: A Bandwidth Efficient Hybrid-Secure Signal Protocol*](https://eprint.iacr.org/2025/078). IACR ePrint Archive 2025/078; EUROCRYPT 2025.

[**Bit-dropping on the encapsulation key**]{#bit-dropping-on-the-encapsulation-key}

<!-- topics:start -->
<div class="cj-tags cj-page-topics"><a class="cj-tag cj-tag-topic" href="/projects/proposals/by-topic/index.qmd#learning-with-errors">Learning With Errors</a><a class="cj-tag cj-tag-topic" href="/projects/proposals/by-topic/index.qmd#secure-messaging">Secure Messaging</a></div>
<!-- topics:end -->
...
Yevgeniy Dodis, Bernardo Magri, Noah Stephens-Davidowitz, Yiannis Tselekounis. [*Guarding the Signal: Secure Messaging with Reverse Firewalls*](https://eprint.iacr.org/2025/1172). IACR ePrint Archive 2025/1172; CRYPTO 2025.

[**A subversion-resilient post-quantum X3DH**]{#a-subversion-resilient-post-quantum-x3dh}

<!-- topics:start -->
<div class="cj-tags cj-page-topics"><a class="cj-tag cj-tag-topic" href="/projects/proposals/by-topic/index.qmd#secure-messaging">Secure Messaging</a><a class="cj-tag cj-tag-topic" href="/projects/proposals/by-topic/index.qmd#subversion-resistance">Subversion Resistance</a></div>
<!-- topics:end -->
...
[**Firewall rerandomization under an additional encryption layer**]{#firewall-rerandomization-under-an-additional-encryption-layer}
...
Lea Thiemt, Paul Rösler, Alexander Bienstock, Rolfe Schmidt, Yevgeniy Dodis. [*Generic Anonymity Wrapper for Messaging Protocols*](https://eprint.iacr.org/2025/1619). IACR ePrint Archive 2025/1619; ACM CCS 2025.

[**Modifying the Double Ratchet directly for anonymity**]{#modifying-the-double-ratchet-directly-for-anonymity}

<!-- topics:start -->
<div class="cj-tags cj-page-topics"><a class="cj-tag cj-tag-topic" href="/projects/proposals/by-topic/index.qmd#anonymity">Anonymity</a><a class="cj-tag cj-tag-topic" href="/projects/proposals/by-topic/index.qmd#secure-messaging">Secure Messaging</a></div>
<!-- topics:end -->
...
[**Anonymity guarantees beyond message content**]{#anonymity-guarantees-beyond-message-content}
...
Benedikt Auerbach, Yevgeniy Dodis, Daniel Jost, Shuichi Katsumata, Rolfe Schmidt. [*How to Compare Bandwidth Constrained Two-Party Secure Messaging Protocols: A Quest for A More Efficient and Secure Post-Quantum Protocol*](https://eprint.iacr.org/2025/2267). Cryptology ePrint Archive 2025/2267.

[**Session-handling in the vulnerable-message-set methodology**]{#session-handling-in-the-vulnerable-message-set-methodology}

<!-- topics:start -->
<div class="cj-tags cj-page-topics"><a class="cj-tag cj-tag-topic" href="/projects/proposals/by-topic/index.qmd#secure-messaging">Secure Messaging</a></div>
<!-- topics:end -->
...
[**Capturing root-key forward secrecy in the vulnerable-message-set metric**]{#capturing-root-key-forward-secrecy-in-the-vulnerable-message-set-metric}
...
James Bartusek, Nir Bitansky, Yevgeniy Dodis, Rachit Garg, David J. Wu. [*Fair-Weather No More: Guaranteed Efficiency in Secure Group Messaging*](https://eprint.iacr.org/2026/1677). IACR Cryptology ePrint Archive 2026/1677.

[**CGKA security against fully active adversaries**]{#cgka-security-against-fully-active-adversaries}
...
[**Per-party storage independent of group size**]{#per-party-storage-independent-of-group-size}
...
Yevgeniy Dodis, Shachar Lovett, Daniel Wichs. [*Locally Computable High Independence Hashing*](https://eprint.iacr.org/2026/622). IACR Cryptology ePrint Archive 2026/622.

[**Unifying bit-local and word-local hash constructions**]{#unifying-bit-local-and-word-local-hash-constructions}

<!-- topics:start -->
<div class="cj-tags cj-page-topics"><a class="cj-tag cj-tag-topic" href="/projects/proposals/by-topic/index.qmd#k-wise-independent-hashing">K Wise Independent Hashing</a></div>
<!-- topics:end -->
...
The paper builds its almost-$k$-wise-independent hash families two different ways depending on the word size regime, rather than from one construction spanning every word size. A single unified construction covering the whole range -- including the intermediate word sizes where, as [c/0066](/c/0066/) records, no matching construction of either kind is currently known -- is named as a desirable simplification, distinct from that page's own question of narrowing the locality gap itself.
