...
- [ ] **UC Encyclopedia content (~5h — manual: sourcing and verifying real citations per functionality, not just drafting text)**
  ...
  66 of the 104 functionality pages (`uc/layer-N-.../<id>/index.qmd`) are still stubs — measured 18 August 2026. Thirty-eight are written: the seven ported from `surveys/uc-for-gamers/latex/main.tex` (F-Rand, F-Store, F-Sig, G-PKI, G-Clock, F-Net, F-AC), then F-CRS, F-COM, F-ZK, F-auth, F-OT, G-RO, then — 17 August — F-smt, F-MCOM and F-BC, and — 18 August — F-CERT, F-ACRS, F-PKI, F-syn, F-KR, F-CP, F-COT, F-RBC, F-SA, F-wrap, F-ABA, F-diffuse, F-PKE, F-rPKE, F-aPKE, F-pwKE, F-OLE, F-coin, F-beacon, F-BlSig, F-VRF and F-TLP. Layers 6, 7 and 8 have their first entries.
