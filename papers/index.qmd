...
- **Archive** -- the papers themselves.
  - [The Uber Assumption and its Random Self-Reducibility](/papers/uber-groups-rsr/index.qmd) -- working draft, in the generic-group model, across non-bilinear and Type 1, 2 and 3 bilinear groups.
- [Programme Committee](/papers/programme-committee/index.qmd) -- who reviews them, and how.
- [Proposals](/papers/proposals/index.qmd) -- focused research topics, for whoever has the idea but not the resources to work it.
- [Example Paper](/papers/example-paper/index.qmd) -- not a paper: the frontmatter contract and folder layout a new paper is copied from.
