...
\definecolor{accentsoft}{HTML}{4A7BA7}  % urls
...
% ---------- box panels and theorem environments ----------
\tcbset{panel/.style={%
  enhanced,
...
%% statements sit in a tinted panel; proofs and remarks stay outside it
...
\title{The Uber Assumption and its Random Self-Reducibility\\
...
\begin{aligned}
  ...
  \text{Type 2 } (\psi\colon\Gtwo\to\Gone):\quad
      & \LL_{1}=\Span{R\cup S},\quad \LL_{2}=\Span{S},\quad
        \LL_{T}=\Span{(R\cup S)\cdot S\ \cup\ T};\\[2pt]
  \text{Type 3:}\quad
