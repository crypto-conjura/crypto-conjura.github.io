...
\title{\textbf{\Large Open Problem Note:}\\[0.2em] \Large Exact Full Indifferentiability of 6-Round Feistel Networks}
...
\begin{definition}[Indifferentiability Framework (Maurer et al., 2002)]
...
\textbf{r = 6} & \textbf{OPEN} & \textbf{Public / Sequential Indiff. Only} & \textbf{Dai et al. (2018)} \\
$r \ge 7$ & Proven & $O(q^{16}/2^n)$ or better & Ito et al. (2021) \\ \bottomrule
\end{tabular}
