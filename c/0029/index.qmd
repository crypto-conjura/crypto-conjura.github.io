...
topics: [one-way-functions, black-box-separations, quantum-cryptography]
model: standard
form: equivalence
...
**Checked against the literature, 2026-08-19.** Searched for citations of and follow-ups to Buxbaum–Mahmoody (eprint 2024/2095, IACR CiC Jan 2025) addressing the non-black-box case, and checked Mahmoody's homepage; found nothing. Confidence is inherently low given how recent the source paper is — follow-up work may simply not exist yet — but the conjecture remains open as far as could be determined.
