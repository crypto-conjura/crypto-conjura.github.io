...
**Checked against the literature, 2026-08-19.** Searched for follow-ups to the source paper and found "Fine-Grained Non-Interactive Key Exchange, Revisited" (Cryptology ePrint Archive, Report 2024/834; CRYPTO 2024), which shows a protocol secure in Maurer's model with a gap up to $N^{1.6}$ assuming non-uniformly secure injective pseudorandom generators with exponential hardness — genuine progress narrowing the gap left by Afshar et al., but short of the quadratic gap asked for here and, unusually for a generic-group-model result, conditional on a computational assumption rather than unconditional; the conjecture as stated remains open.
