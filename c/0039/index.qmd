...
topics: [witness-encryption, one-shot-signatures]
model: standard
form: assumption
...
<!-- topics:start -->
<div class="cj-tags cj-page-topics"><a class="cj-tag cj-tag-topic" href="/problems/by-topic/one-shot-signatures/">One Shot Signatures</a><a class="cj-tag cj-tag-topic" href="/problems/by-topic/witness-encryption/">Witness Encryption</a></div>
<!-- topics:end -->
...
**Checked against the literature, 2026-08-19.** Searched "one-shot signatures witness encryption extractability 2026," "threshold one-shot decryption non-extractable witness encryption," and reviewed the recent one-shot-signature literature (Shmueli–Zhandry, CRYPTO 2025; arXiv 2510.10899; arXiv 2507.12456; arXiv 2606.23612); none address removing the extractability requirement from a threshold-one-shot-decryption-style reduction, or building the primitive from indistinguishability-secure witness encryption alone, and the source (eprint 2026/1072) is itself only about three months old. Verdict: still open.
